...
public class UserController {
    ...
    public ResponseEntity<UserModel> createNewStudent(@RequestBody UserModel user,@RequestParam Long id){
        return new ResponseEntity<>(service.createNewStudent(user,id),HttpStatus.OK);
    }
